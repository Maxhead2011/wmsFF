...
RUN cp /usr/share/nginx/html/downloads/logoff-tsd-admin-box-count-158.apk /usr/share/nginx/html/downloads/logoff-tsd.apk && chmod 0644 /usr/share/nginx/html/downloads/logoff-tsd.apk
