...
export class StorageLocationsController {
  ...
  @Post('pallets/bulk-delete')
  @RequirePermissions('warehouse:write')
  deletePallets(@Body() body: Record<string, unknown>, @CurrentUser() user: AuthUser) {
    return this.storage.deletePallets(body, user);
  }

  @Post('pallets/:id/clear')
  @RequirePermissions('warehouse:write')
  clearPallet(@Param('id') id: string, @CurrentUser() user: AuthUser) {
    return this.storage.clearPallet(id, user);
  }
