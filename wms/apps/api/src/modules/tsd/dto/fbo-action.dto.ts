...
export class FboActionDto {
    ...
    @IsIn(['START', 'PICK_UNIT', 'PICK_BOX', 'FINISH_PICK', 'TRANSFER_REMAINDER', 'OPEN_BOX', 'MANUAL_OPEN_BOX', 'MANUAL_PACK_UNIT', 'PACK_UNIT', 'PACK_BOX', 'CLOSE_BOX', 'CANCEL_EMPTY_BOX', 'SORTED', 'CONFIRM_BOX', 'FINISH'])
    action!: string;
    @IsString()
    @MinLength(8)
    @MaxLength(100)
