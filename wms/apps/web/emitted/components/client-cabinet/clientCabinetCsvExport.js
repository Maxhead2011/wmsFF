import { billingInvoiceStatusLabel, billingStatusLabel, billingUnitLabel, formatCabinetDate, formatCabinetMoney, formatCabinetNumber, requestStatusLabel, requestTypeLabel, } from './clientCabinetFormat';
export function downloadClientCabinetDocumentsCsv(data) {
    const rows = [
...
export function downloadClientCabinetFinanceCsv(data) {
    const rows = [
        ['Клиент', data.client.code, data.client.name],
        ['Период', exportPeriodLabel(data.filters)],
        [],
...
function exportPeriodLabel(filters) {
...
function csvFileName(clientCode, suffix) {
