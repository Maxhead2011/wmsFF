import { BriefcaseBusiness, BarChart3, Building2, Boxes, Bug, Calculator, CircleDollarSign, ClipboardCheck, ClipboardList, Crown, Database, FolderCog, FileSignature, HandCoins, LayoutDashboard, MapPinned, MessageSquareMore, MonitorUp, PackageCheck, PackageSearch, Printer, RefreshCw, ScanLine, ShieldCheck, ShoppingBasket, Settings2, Tags, Truck, Upload, } from 'lucide-react';
export const workspaceNav = [
    ...
    },
    {
        ...
        description: 'Очередь проблемных КИЗ после FBS-отбора, исправление данных WMS и повторная синхронизация с Wildberries.',
...
export function canOpenWorkspace(user, item) {
