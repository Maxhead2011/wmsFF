...
Baseline `2026-09-26-turnover`; маршрут №1368 проверен на опубликованном модуле.
...
Снимок `wms/baselines/our-wms/2026-09-26-turnover` сохраняет runtime после PR321 (товарооборот; маршруты FBS и Ozon215 сохранены):
